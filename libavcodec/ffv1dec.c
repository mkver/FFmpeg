                        ...
                        int *got_frame, AVPacket *avpkt)
{
    ...
    ff_thread_progress_unref(&f->last_picture);
...
static int update_thread_context(AVCodecContext *dst, const AVCodecContext *src)
{
    ...
    ff_thread_progress_replace(&fdst->picture, &fsrc->picture);
...
static av_cold int ffv1_decode_close(AVCodecContext *avctx)
{
    ...
    ff_thread_progress_unref(&s->picture);
    ff_thread_progress_unref(&s->last_picture);
