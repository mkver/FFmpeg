...
typedef struct CodedBitstreamUnit {
    ...
    void *content;
    /**
     * NULL if content is not reference counted; otherwise a pointer
 ...
 *
 * If content_ref is supplied, it has to agree with content
 * which must be refcounted via the refstruct-API.
